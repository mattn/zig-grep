...
pub const dirs = struct {
    pub const _root = "";
    pub const _e6q47gagsfqh = cache ++ "/../..";
    pub const _6ah61dvqbwbn = cache ++ "/git/github.com/tiehuis/zig-regex";
};
...
pub const package_data = struct {
    ...
    pub const _e6q47gagsfqh = Package{
        .directory = dirs._e6q47gagsfqh,
    };
    pub const _6ah61dvqbwbn = Package{
        .directory = dirs._6ah61dvqbwbn,
        .pkg = Pkg{ .name = "regex", .source = .{ .path = dirs._6ah61dvqbwbn ++ "/src/regex.zig" }, .dependencies = null },
    };
};

pub const packages = &[_]Package{
    package_data._6ah61dvqbwbn,
};

pub const pkgs = struct {
    pub const regex = package_data._6ah61dvqbwbn;
};
